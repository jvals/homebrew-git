...
class Git < Formula
  desc "Git with easier to read diffs. Will break all kinds of tools"
  homepage "https://github.com/jvals/git"
  license "https://github.com/jvals/git/blob/maint/COPYING"
  head "https://github.com/jvals/git.git", :branch => "maint"
  version "2.30.2"
